    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        buttonCancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(id!=0){ // Suppression
                    try {
                        com.example.tpgr5msi.ConnectionRest connectionRest = new com.example.tpgr5msi.ConnectionRest();
                ...
                Intent intent = new Intent(EditActivity.this, com.example.tpgr5msi.MainActivity.class);
